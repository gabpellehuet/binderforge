...
# 14-09-2026
# UPDATES & CORRECTIONS:
# - Fixed RFdiffusion 3 (Pydantic) validation errors for `select_hotspots`.
#   The API requires a strict dictionary mapping residues to atom selections 
#   (e.g., {"A17": "ALL"}), not a raw list or nested dictionary.
# - Implemented a smart parser to allow flexible, PyMOL-style atom selections 
#   directly in config.yaml. Accepted formats in `hotspot_residues` list:
#     * "A17"        -> Defaults to all atoms: {"A17": "ALL"}
#     * "A11 all"    -> Space separator:       {"A11": "ALL"}
#     * "A44 CE2"    -> Specific atom:         {"A44": "CE2"}
#     * "A50:CA,CB"  -> Colon separator:       {"A50": "CA,CB"}
# ==============================================================================
